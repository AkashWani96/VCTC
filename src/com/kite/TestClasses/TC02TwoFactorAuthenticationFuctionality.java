...
import com.kite.POMClasses.TwoFactorAuthentication;

public class TC02TwoFactorAuthenticationFuctionality 
{
...
System.setProperty("webdriver.chrome.driver","D:\\Software Testing\\Automation Testing\\04. Selenium\\chromedriver_win32\\chromedriver.exe");
		...
		tfa.sendPin();
		System.out.println("7. entered pin");
		tfa.sendcontinueButton();
		System.out.println("8. click on continue button");
